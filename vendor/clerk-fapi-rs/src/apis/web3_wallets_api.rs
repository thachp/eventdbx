...
pub async fn attempt_web3_wallet_verification(
    ...
    signature: &str,
    origin: Option<&str>,
) -> Result<models::ClientClientWrappedWeb3Wallet, Error<AttemptWeb3WalletVerificationError>> {
    ...
    let uri_str = format!(
        ...
        web3_wallet_id = crate::apis::urlencode(p_path_web3_wallet_id)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ClientClientWrappedWeb3Wallet`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ClientClientWrappedWeb3Wallet`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AttemptWeb3WalletVerificationError> =
...
pub async fn delete_web3_wallet(
    configuration: &configuration::Configuration,
    web3_wallet_id: &str,
) -> Result<models::ClientClientWrappedDeletedObject, Error<DeleteWeb3WalletError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_web3_wallet_id = web3_wallet_id;
...
pub async fn get_web3_wallets(
...
) -> Result<Vec<models::ClientWeb3Wallet>, Error<GetWeb3WalletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::ClientWeb3Wallet&gt;`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::ClientWeb3Wallet&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn post_web3_wallets(
    ...
    web3_wallet: &str,
    _clerk_session_id: Option<&str>,
) -> Result<models::ClientClientWrappedWeb3Wallet, Error<PostWeb3WalletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn prepare_web3_wallet_verification(
...
) -> Result<models::ClientClientWrappedWeb3Wallet, Error<PrepareWeb3WalletVerificationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_web3_wallet_id = web3_wallet_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PrepareWeb3WalletVerificationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn read_web3_wallet(
    configuration: &configuration::Configuration,
    web3_wallet_id: &str,
) -> Result<models::ClientClientWrappedWeb3Wallet, Error<ReadWeb3WalletError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_web3_wallet_id = web3_wallet_id;
