...
pub async fn attempt_passkey_verification(
...
) -> Result<models::ClientClientWrappedPasskey, Error<AttemptPasskeyVerificationError>> {
    ...
    let uri_str = format!(
        ...
        passkey_id = crate::apis::urlencode(p_path_passkey_id)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ClientClientWrappedPasskey`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ClientClientWrappedPasskey`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_passkey(
    configuration: &configuration::Configuration,
    passkey_id: &str,
) -> Result<models::ClientClientWrappedDeletedObject, Error<DeletePasskeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_passkey_id = passkey_id;
...
pub async fn patch_passkey(
    ...
    passkey_id: &str,
    name: Option<&str>,
) -> Result<models::ClientClientWrappedPasskey, Error<PatchPasskeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_passkey_id = passkey_id;
...
) -> Result<models::ClientClientWrappedPasskey, Error<PostPasskeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn read_passkey(
    configuration: &configuration::Configuration,
    passkey_id: &str,
) -> Result<models::ClientClientWrappedPasskey, Error<ReadPasskeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_passkey_id = passkey_id;
